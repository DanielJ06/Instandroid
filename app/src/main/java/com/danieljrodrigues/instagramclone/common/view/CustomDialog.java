package com.danieljrodrigues.instagramclone.common.view;
...
public class CustomDialog extends Dialog {
    ...
    private LinearLayout dialogLinearContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogLinearContainer = findViewById(R.id.dialog_container);
    ...
    public void show() {
        ...
        for (TextView textView : textViews) {
            dialogLinearContainer.addView(textView, layoutParams);
        }
    }
    ...
    private void addButton(final View.OnClickListener listener, @StringRes int... texts) {
        ...
        for(int i=0; i < texts.length; i++) {
            TextView textView = new TextView(
                new ContextThemeWrapper(getContext(), R.style.InstaDialogTextViewBase),
                null,
                0
            );
